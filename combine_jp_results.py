...
if __name__ == "__main__":
    ...
    jp_results_dir = '_files/RS/results'
    combine_and_process_data(
        results_dir=jp_results_dir,
        stocks_pattern='stocks_jp_chunk_*.csv',
        industries_pattern='industries_jp_chunk_*.csv',
        final_stocks_file='_files/RS/rs_stocks_jp.csv',
        final_industries_file='_files/RS/rs_industries_jp.csv'
    )
